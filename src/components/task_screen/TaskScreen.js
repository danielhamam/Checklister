        ...
        <div className='dashboard'>
            <div class="container">
                ...
                <div id="item_form_container">
                    ...
                    <input id= "item_description_textfield" onChange = {(e) => this.handlePropertyChange(e, 'description')} defaultValue = {task ? task.description : ''} class="item_input" type="input" />
                    
                    <div id="item_assigned_to_prompt" class="item_prompt">Assigned To:</div>
                    <input id="item_assigned_to_textfield" onChange = {(e) => this.handlePropertyChange(e, 'assigned_to')} defaultValue = {task ? task.assigned_to : ''} class="item_input" type="input" />

                    <div id= "item_due_date_prompt"  class="item_prompt">Due Date:</div>
                    <input id="item_due_date_picker" onChange = {(e) => this.handlePropertyChange(e, 'due_date')} defaultValue = {task ? task.due_date : ''} class="item_input" type="date" />
                ...
                <div className='item_form_buttons_container'>
                    <button id="item_form_button" class="item_button" onClick={this.processCancelChanges}>Cancel</button>
                    <button id="item_form_button" class="item_button" onClick= {this.processSubmitChanges} >Submit</button>
                </div> 
                <br />
                <br />
            </div>
